...
- app/api: FastAPI routes and DTOs with cache integration.
...
## Next steps
1. Add OR-Tools solver path with time limits for larger instances.
2. Expand soft constraints (fairness, gaps) and refactoring cost functions.
3. Add comprehensive unit tests for solver, validators, scoring.
4. Implement Dockerfile for application container.
